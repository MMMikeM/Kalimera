...
- **`src/routes/learn/content.llm`:**
  ...
  - Lines 12 & 30 describe `/learn/verbs` as a _"Verb browser by conjugation family"_ instead of an aorist learning inventory (irregulars to memorise vs rule-based regular past classes).
