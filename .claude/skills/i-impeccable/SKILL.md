...
If this skill is invoked with the argument "extract" (e.g., `/i-impeccable extract [target]`), follow the [extract flow](reference/i-extract.md). Pass any additional arguments as the extraction target.