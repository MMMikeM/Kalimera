(function (y, v) {
	...
	function L(e, t) {
		return new Promise((r) => {
			const { timeout: n, ownerDocument: i, onError: _a, onWarn: s } = t != null ? t : {},
			...
			if ((n && (c = setTimeout(l, n)), Y(o))) {
				...
				const m = l,
					f = (h) => {
						(s == null || s("Failed video load", d, h), _a == null || _a(h), l());
					};
				((u = () => {
...
`);
	...
	function Rt(e, t, r, n) {
		...
		(l.delete("transition-property"),
			...
			((_d = l.get("background-clip")) == null ? void 0 : _d[0]) === "text" &&
  ...
  `);
	...
	function _t(e, t) {
		const { backgroundColor: _r, width: n, height: i, style: a } = t,
			s = e.style;
		if (
			(_r && s.setProperty("background-color", _r, "important"),
	...
	function De(e, t) {
		const { tasks: r } = t;
		(I(e) && (($(e) || ce(e)) && r.push(...Ot(e, t)), _Qe(e) && r.push(...jt(e, t))),
...
`;
			...
			const w = Yt(g, r);
			return (
				_o && w.insertBefore(_o, w.children[0]),
