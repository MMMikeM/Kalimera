...
Why timed production drills work, grounded in second language acquisition research.

## The Declarative-Procedural-Automatic Progression
...
- Built through massive procedural practice

**The transition from declarative to procedural requires retrieval under time pressure.** Without pressure, learners fall back to slow, conscious rule application, which reinforces declarative processing rather than building procedural skill.

## Why Recognition Doesn't Transfer to Production
...
This is why traditional flashcards (Greek → English) feel productive but don't help speaking. The learner gets faster at recognising, not producing.
...
- Knowledge never becomes automatic

The discomfort of time pressure is the learning signal. If it feels comfortable, proceduralization isn't happening.
...
**Errors are data, not failure.** A drill system should expect ~20-40% errors on new material and track error rate reduction over time.
...
The +1 is speed, not complexity. They don't need harder Greek. They need faster retrieval of Greek they already know.
...
An item isn't "learned" when the user gets it right. It's learned when they get it right in under 3 seconds.
...
A few minutes of practice per day isn't enough. The app should facilitate 15-30 minutes of drilling daily, with 100+ production attempts per session.
...
4. The learner has drilled enough to achieve automaticity

**The goal is not perfection in drills. The goal is speed in drills that transfers to speed in conversation.**
