...
|--------------------------|-------------------------|---------------------|
| Pronoun paradigms        | Singular                | Plural              |
| Article paradigms        | Nominative + Accusative | Genitive            |
| Verb conjugations        | Singular forms          | Plural forms        |
| Noun declension examples | One example per pattern | Additional examples |

Learn section (vocabulary):

| Content               | Default View    | Expandable             |
|-----------------------|-----------------|------------------------|
| Vocabulary categories | Category list   | Items within category  |
| Verb families         | Family overview | Full conjugation table |
...
<incorrect reason="abstract category without context">
"Accusative Case"
"Genitive Case"
</incorrect>
</rule>
...
| Section           | Content         | Primary Organisation                   | Secondary Indicator             |
|-------------------|-----------------|----------------------------------------|---------------------------------|
| /learn/vocabulary | Nouns           | Semantic (topic: food, family, travel) | Gender badge                    |
| /learn/vocabulary | Verbs           | Conjugation family (-ω, -άω, deponent) | Frequency marker                |
| /learn/vocabulary | Reference words | Function (numbers, colours, time)      | Opposites paired                |
| /learn/phrases    | Phrases         | Communicative function                 | Pattern notes                   |
| /reference        | Grammar         | Function-first                         | Grammatical term in parentheses |
</rule>
...
12. -άω verbs, deponent verbs, irregular είμαι
...
- [ ] organisation-by-type: Vocab by semantic topic, grammar by function
...
<output-format>
When proposing content changes, use this structure:

<example name="output-template">
## [Section Name]
