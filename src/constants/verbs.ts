...
export const VERB_PATTERNS: Record<string, VerbPattern> = {
	active: {
		...
		description:
			"Most Greek verbs follow this pattern. Learn the endings once, apply them to thousands of verbs.",
		endings: {
			sg1: "-ω",
			sg2: "-εις",
			sg3: "-ει",
