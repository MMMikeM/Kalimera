				...
				<table className="w-full text-sm border-collapse">
					<thead>
						<tr className="border-b border-honey-300">
							...
							<th className="text-left py-1.5 px-2 text-stone-500 font-medium text-xs">Emphatic</th>
						</tr>
					</thead>
					<tbody>
						<tr>
							<td className="py-1.5 px-2 text-stone-600 text-xs">me / my</td>
							<td className="py-1.5 px-2"><MonoText size="sm">με</MonoText></td>
							<td className="py-1.5 px-2"><MonoText size="sm">μου</MonoText></td>
							<td className="py-1.5 px-2"><MonoText size="sm">εμένα</MonoText></td>
						</tr>
						<tr>
							<td className="py-1.5 px-2 text-stone-600 text-xs">you / your</td>
							<td className="py-1.5 px-2"><MonoText size="sm">σε</MonoText></td>
							<td className="py-1.5 px-2"><MonoText size="sm">σου</MonoText></td>
							<td className="py-1.5 px-2"><MonoText size="sm">εσένα</MonoText></td>
						</tr>
						<tr>
							<td className="py-1.5 px-2 text-stone-600 text-xs">him / his</td>
							<td className="py-1.5 px-2"><MonoText size="sm">τον</MonoText></td>
							<td className="py-1.5 px-2"><MonoText size="sm">του</MonoText></td>
							<td className="py-1.5 px-2"><MonoText size="sm">αυτόν</MonoText></td>
						</tr>
						<tr>
							<td className="py-1.5 px-2 text-stone-600 text-xs">her</td>
							<td className="py-1.5 px-2"><MonoText size="sm">την</MonoText></td>
							<td className="py-1.5 px-2"><MonoText size="sm">της</MonoText></td>
							<td className="py-1.5 px-2"><MonoText size="sm">αυτήν</MonoText></td>
						</tr>
					</tbody>
				</table>
			</div>
