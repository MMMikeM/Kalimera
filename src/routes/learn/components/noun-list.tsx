...
export const nounSubgroups: Record<string, Array<{ title: string; words: string[] }>> = {
	people: [
		...
		},
		{
			...
			words: ["θείος", "θεία", "ξάδερφος", "ξαδέρφη", "ανιψιός", "ανιψιά", "εγγονός", "εγγονή"],
		},
		{ title: "In-laws", words: ["πεθερός", "πεθερά", "γαμπρός", "νύφη"] },
		{ title: "Partners & friends", words: ["άντρας", "γυναίκα", "φίλος", "φίλη", "σύζυγος"] },
		{
			title: "People & pets",
			words: ["άνθρωπος", "κόσμος", "γείτονας", "γειτόνισσα", "νάνος", "σκύλος"],
		},
	],
	"time-calendar": [
		{
		...
		{ title: "Seasons", words: ["άνοιξη", "καλοκαίρι", "φθινόπωρο", "χειμώνας"] },
		{
			...
			words: ["πρωί", "μεσημέρι", "απόγευμα", "βράδυ", "νύχτα", "μεσάνυχτα"],
		},
	],
	"work-study": [
		{
	...
	summer: [
		{
			title: "At the beach",
			words: ["θάλασσα", "παραλία", "ήλιος", "ξαπλώστρα", "μαγιό", "καπέλο"],
		},
