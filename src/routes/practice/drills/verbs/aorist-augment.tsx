...
const ITEMS: SimpleListItem[] = [
	...
	},
	{
		...
		greeklish: "vrika",
		english: "find",
		context: "βρίσκω · 2 syllables",
		label: "βρίσκω → 2 syl → ε-",
		category: "augment",
		dimension: "augment",
	},
	...
	// ── 3+ syllable present → stress shifts, no ε- ───────────────────────────
	{
		...
		greeklish: "doulepsa",
		english: "work",
		context: "δουλεύω · 3 syllables",
		label: "δουλεύω → 3 syl → shift",
		category: "noaugment",
		dimension: "noaugment",
	},
	{
		...
		greeklish: "milisa",
		english: "speak",
		context: "μιλάω · 3 syllables",
		label: "μιλάω → 3 syl → shift",
		category: "noaugment",
		dimension: "noaugment",
	},
	{
		...
		greeklish: "akousa",
		english: "hear",
		context: "ακούω · 3 syllables",
		label: "ακούω → 3 syl → shift",
		category: "noaugment",
		dimension: "noaugment",
	},
	{
		...
		greeklish: "agapisa",
		english: "love",
		context: "αγαπάω · 4 syllables",
		label: "αγαπάω → 4 syl → shift",
		category: "noaugment",
		dimension: "noaugment",
	},
	{
		...
		greeklish: "diavasa",
		english: "read",
		context: "διαβάζω · 4 syllables",
		label: "διαβάζω → 4 syl → shift",
		category: "noaugment",
		dimension: "noaugment",
	},
	{
		...
		english: "remember",
		context: "θυμάμαι · 4 syllables",
		label: "θυμάμαι → 4 syl → shift",
		category: "noaugment",
		dimension: "noaugment",
	},
	{
		...
		greeklish: "irtha",
		english: "come",
		context: "έρχομαι · 3 syllables",
		label: "έρχομαι → 3 syl → shift",
		category: "noaugment",
		dimension: "noaugment",
	},
	{
		...
		greeklish: "perimena",
		english: "wait",
		context: "περιμένω · 4 syllables",
		label: "περιμένω → 4 syl → shift",
		category: "noaugment",
		dimension: "noaugment",
	},
];
