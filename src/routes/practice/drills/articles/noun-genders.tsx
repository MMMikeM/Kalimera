...
const NOUNS: SimpleListItem[] = [
	...
	},
	{
		id: "thalassa",
		greek: "η θάλασσα",
		greeklish: "i thalassa",
		english: "sea",
		label: "feminine",
		category: "feminine",
		dimension: "feminine",
		reverseGreek: "θάλασσα",
	},
	{
		id: "porta",
		greek: "η πόρτα",
	...
	},
	{
		id: "oikogeneia",
		greek: "η οικογένεια",
		greeklish: "i ikogenia",
		english: "family",
		label: "feminine",
		category: "feminine",
		dimension: "feminine",
		reverseGreek: "οικογένεια",
	},
	// Neuter (το)
	{
		id: "spiti",
	...
	},
	{
		id: "estiatorio",
		greek: "το εστιατόριο",
		greeklish: "to estiatorio",
		english: "restaurant",
		label: "neuter",
		category: "neuter",
		dimension: "neuter",
		reverseGreek: "εστιατόριο",
	},
	{
		id: "xenodocheio",
		greek: "το ξενοδοχείο",
		greeklish: "to xenodocheio",
		english: "hotel",
		label: "neuter",
		category: "neuter",
		dimension: "neuter",
		reverseGreek: "ξενοδοχείο",
	},
	{
		id: "proi",
		greek: "το πρωί",
