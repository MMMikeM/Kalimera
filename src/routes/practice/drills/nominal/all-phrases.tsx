...
import { PHRASES as DOER } from "./phrase-doer";
import { PHRASES as OWNER } from "./phrase-owner";
import { PHRASES as TARGET } from "./phrase-target";
...
export default function AllPhrasesDrill() {
	return (
		<SimpleListDrill
