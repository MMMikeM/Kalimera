...
const OBJECT_PRONOUN_SENTENCES: SentenceTemplate[] = [
	...
	{
		id: "obj-se-1",
		sentence: "Σε περιμένω",
		english: "I'm waiting for you",
		targetPronoun: "Σε",
		targetMeaning: "you (sing)",
		pronounType: "object",
	},
	{
		id: "obj-se-2",
	...
	{
		id: "obj-mas-1",
		sentence: "Μας περιμένουν",
		english: "They're waiting for us",
		targetPronoun: "Μας",
		targetMeaning: "us",
		pronounType: "object",
	},
	{
		id: "obj-sas-1",
		sentence: "Σας ακούω",
		english: "I hear you (all)",
		targetPronoun: "Σας",
		targetMeaning: "you (pl/formal)",
		pronounType: "object",
	},
	{
		id: "obj-tous-1",
		...
		english: "I see them",
		targetPronoun: "Τους",
		targetMeaning: "them (m)",
		pronounType: "object",
	},
	{
		id: "obj-tis-1",
		sentence: "Τις ξέρω",
		english: "I know them (f)",
		targetPronoun: "Τις",
		targetMeaning: "them (f)",
		pronounType: "object",
	},
	{
		id: "obj-ta-1",
		sentence: "Τα έχω",
		english: "I have them (n)",
		targetPronoun: "Τα",
		targetMeaning: "them (n)",
		pronounType: "object",
	},
];
...
const POSSESSIVE_PRONOUN_SENTENCES: SentenceTemplate[] = [
	...
	{
		id: "poss-sou-1",
		sentence: "Το όνομά σου",
		english: "your name",
		targetPronoun: "σου",
		targetMeaning: "your (sing)",
		pronounType: "possessive",
	},
	{
		id: "poss-sou-2",
		sentence: "Ο φίλος σου",
		english: "your friend",
		targetPronoun: "σου",
		targetMeaning: "your (sing)",
		pronounType: "possessive",
	...
	{
		id: "poss-sas-1",
		sentence: "Το όνομά σας",
		english: "your (pl) name",
		targetPronoun: "σας",
		targetMeaning: "your (pl/formal)",
		pronounType: "possessive",
	},
	{
		id: "poss-tous-1",
		sentence: "Τα παιδιά τους",
...
const generateQuestions = (): Question[] => {
	...
	const allSentences = [
		...OBJECT_PRONOUN_SENTENCES,
		...POSSESSIVE_PRONOUN_SENTENCES,
	];
	...
	for (const template of allSentences) {
		...
		const wrongOptions = allPronouns
			.filter(
				(p) =>
					p.type === template.pronounType &&
					p.english !== template.targetMeaning,
			)
			.map((p) => p.english);
		...
		const typeLabel =
			template.pronounType === "object" ? "object pronoun" : "possessive";
		const positionHint =
			template.pronounType === "object" ? "before the verb" : "after the noun";
	...
	const fillInBlankTemplates = [
		...
		{
			id: "fill-obj-1",
			sentence: "___ βλέπεις;",
			english: "Do you see me?",
			correct: "Με",
			wrongOptions: ["Σε", "Τον", "Μας"],
			type: "object",
		},
		{
			id: "fill-obj-2",
			sentence: "___ περιμένω",
			english: "I'm waiting for you",
			correct: "Σε",
			wrongOptions: ["Με", "Την", "Τους"],
			type: "object",
		},
		{
			id: "fill-obj-3",
			sentence: "___ ξέρω καλά",
			english: "I know him well",
			correct: "Τον",
			wrongOptions: ["Με", "Σε", "Την"],
			type: "object",
		},
		{
			id: "fill-obj-4",
		...
		},
		{
			...
			english: "I want it",
			correct: "Το",
			wrongOptions: ["Τον", "Την", "Τα"],
			type: "object",
		},
		{
			id: "fill-obj-6",
			sentence: "___ περιμένουν",
			english: "They're waiting for us",
			correct: "Μας",
			wrongOptions: ["Σας", "Με", "Τους"],
			type: "object",
		},
		// Possessive pronouns
		{
			id: "fill-poss-1",
			sentence: "Το σπίτι ___",
			english: "my house",
			correct: "μου",
			wrongOptions: ["σου", "του", "μας"],
			type: "possessive",
		},
		{
			id: "fill-poss-2",
			sentence: "Το όνομά ___",
			english: "your name",
			correct: "σου",
			wrongOptions: ["μου", "της", "σας"],
			type: "possessive",
		},
		{
			id: "fill-poss-3",
			sentence: "Ο πατέρας ___",
			english: "his father",
			correct: "του",
			wrongOptions: ["της", "μου", "τους"],
			type: "possessive",
		},
		{
			id: "fill-poss-4",
			sentence: "Η μητέρα ___",
			english: "her mother",
			correct: "της",
			wrongOptions: ["του", "σου", "μας"],
			type: "possessive",
		},
		{
			id: "fill-poss-5",
			sentence: "Η οικογένειά ___",
			english: "our family",
			correct: "μας",
			wrongOptions: ["σας", "μου", "τους"],
			type: "possessive",
		},
		{
			id: "fill-poss-6",
			sentence: "Τα παιδιά ___",
			english: "their children",
			correct: "τους",
			wrongOptions: ["μας", "σας", "του"],
			type: "possessive",
		},
	];
	...
	for (const template of fillInBlankTemplates) {
		...
		const typeLabel =
			template.type === "object" ? "object pronoun" : "possessive";
	...
	for (const paradigm of OBJECT_PRONOUNS) {
		// Singular
		{
			const wrongOptions = allPronouns
				.filter(
					(p) => p.type === "object" && p.english !== paradigm.singular.english,
				)
				.map((p) => p.english);
			const selectedWrong = shuffleArray(wrongOptions).slice(0, 3);
			const options = shuffleArray([
				paradigm.singular.english,
				...selectedWrong,
			]);
		...
		// Plural
		{
			const wrongOptions = allPronouns
				.filter(
					(p) => p.type === "object" && p.english !== paradigm.plural.english,
				)
				.map((p) => p.english);
			const selectedWrong = shuffleArray(wrongOptions).slice(0, 3);
	...
	for (const paradigm of POSSESSIVE_PRONOUNS) {
		// Singular
		{
			const wrongOptions = allPronouns
				.filter(
					(p) =>
						p.type === "possessive" && p.english !== paradigm.singular.english,
				)
				.map((p) => p.english);
			const selectedWrong = shuffleArray(wrongOptions).slice(0, 3);
			const options = shuffleArray([
		...
		// Plural
		{
			const wrongOptions = allPronouns
				.filter(
					(p) =>
						p.type === "possessive" && p.english !== paradigm.plural.english,
				)
				.map((p) => p.english);
			const selectedWrong = shuffleArray(wrongOptions).slice(0, 3);
			const options = shuffleArray([paradigm.plural.english, ...selectedWrong]);
