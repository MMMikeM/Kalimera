...
const UNAUTHENTICATED_DASHBOARD = {
	userId: null as null,
	stats: { streak: 0, itemsMastered: 0, dueCount: 0, totalLearned: 0, newAvailable: 0 },
	weekData: Array.from({ length: 7 }, () => ({ practiced: false })),
	todayPracticed: false,
	freezeStatus: { status: "none" as const, freezeCount: 0 },
	daysUntilNextFreeze: null as number | null,
	itemsDueTomorrow: 0,
	daysSinceLastPractice: null as number | null,
	taperOfferPending: false,
};

export const Route = createFileRoute("/")({
	loader: async ({ context }) => {
		if (!context.auth?.userId) return UNAUTHENTICATED_DASHBOARD;
...
function DashboardRoute() {
	...
	// TODO: taper notification response needs server function migration
