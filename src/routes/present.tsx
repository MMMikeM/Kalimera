...
export function meta() {
  return [
    { title: "Present Tense - Greek Conjugation Reference" },
    { name: "description", content: "Greek present tense conjugation patterns" },
  ];
}

export default function PresentTenseRoute() {
