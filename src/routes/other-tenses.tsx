...
import { InfoBox, Table } from "../components/ui";

export function meta() {
  return [
    { title: "Other Tenses - Greek Conjugation Reference" },
    { name: "description", content: "Past, future, and other Greek tense conjugations" },
  ];
}

export default function OtherTensesRoute() {
  return (
