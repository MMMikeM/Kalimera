...
export const FULL_VERB_CONJUGATIONS: FullVerbSeed[] = [
...

	{
		...
		conjugations: [
			{
				tense: "present",
				forms: { sg1: "ζω", sg2: "ζεις", sg3: "ζει", pl1: "ζούμε", pl2: "ζείτε", pl3: "ζουν" },
			},
			{
				tense: "aorist",
				forms: {
	...
	},
	{
		...
		imperatives: {
			imperfective: { singular: "βγαίνε", plural: "βγαίνετε" },
			perfective: { singular: "βγες", plural: "βγείτε" },
		},
	},
	{
		lemma: "μπαίνω",
		...
		imperatives: {
			imperfective: { singular: "μπαίνε", plural: "μπαίνετε" },
			perfective: { singular: "μπες", plural: "μπείτε" },
		},
	},
	{
		lemma: "μαθαίνω",
		...
		imperatives: {
			imperfective: { singular: "μάθαινε", plural: "μαθαίνετε" },
			perfective: { singular: "μάθε", plural: "μάθετε" },
		},
	},
	{
		lemma: "κλαίω",
...

	{
		...
		imperatives: {
			imperfective: { singular: "κάθου", plural: "καθίστε" },
			perfective: { singular: "κάθισε", plural: "καθίστε" },
		},
	},
	{
		lemma: "γίνομαι",
	...
	},
	{
		...
		imperatives: {
			imperfective: { singular: "κατέβαινε", plural: "κατεβαίνετε" },
			perfective: { singular: "κατέβα", plural: "κατεβείτε" },
		},
	},
	{
		lemma: "ανεβαίνω",
		...
		imperatives: {
			imperfective: { singular: "ανέβαινε", plural: "ανεβαίνετε" },
			perfective: { singular: "ανέβα", plural: "ανεβείτε" },
		},
	},
