...
const ADJECTIVES_RAW: AdjectiveSeedInput[] = [
	...
	{ lemma: "χαμηλός", english: "low/short (height)", cefrLevel: "A2" },
	{ lemma: "λυπημένος", english: "sad", cefrLevel: "A2" },
	{ lemma: "άσχημος", english: "ugly", cefrLevel: "A2" },
	{ lemma: "ανοιχτός", english: "open", cefrLevel: "A2" },
	{ lemma: "κλειστός", english: "closed", cefrLevel: "A2" },
	{ lemma: "καινούργιος", english: "new", cefrLevel: "A2" },
	{ lemma: "παλιός", english: "old", cefrLevel: "A2" },
	{ lemma: "γεμάτος", english: "full", cefrLevel: "A2" },
	{ lemma: "άδειος", english: "empty", cefrLevel: "A2" },
	{ lemma: "νέος", english: "young", cefrLevel: "A2" },
	{ lemma: "γέρος", english: "old/elderly", cefrLevel: "A2" },
	{ lemma: "μακρύς", english: "long", cefrLevel: "A2" },
	{ lemma: "κοντός", english: "short (height/length)", cefrLevel: "A2" },
	{ lemma: "βαρύς", english: "heavy", cefrLevel: "A2" },
	{ lemma: "ελαφρύς", english: "light/lightweight", cefrLevel: "B1" },
	{ lemma: "διαφορετικός", english: "different", cefrLevel: "A2" },
	{ lemma: "καθαρός", english: "clean", cefrLevel: "A2" },
	{ lemma: "βρόμικος", english: "dirty", cefrLevel: "B1" },
];
