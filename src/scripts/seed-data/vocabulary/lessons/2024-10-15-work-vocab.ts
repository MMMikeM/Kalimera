...
export const LESSON_2024_10_15 = {
	...
	nouns: [
		...
		{ lemma: "υπολογιστής", gender: "masculine", english: "computer/calculator" },
	...
	phrases: [
		...
		{ text: "μηχανικός λογισμικού", english: "software engineer", metadata: { grammar: "genitive" } },
		{ text: "με δουλεύεις", english: "you're kidding me / messing with me", metadata: { register: "colloquial" } },
	] satisfies Phrase[],
