...
export const LESSON_2024_03_25 = {
	...
	phrases: [
		...
		{ text: "τι δουλειά κάνεις;", english: "what work do you do?", metadata: {} },
		{ text: "είσαι παντρεμένος ή ελεύθερος;", english: "are you married or single?", metadata: {} },
		{ text: "έχεις παιδιά;", english: "do you have children?", metadata: {} },
		{ text: "μιλάς ελληνικά;", english: "do you speak Greek?", metadata: {} },
		{ text: "σου αρέσει η Κύπρος;", english: "do you like Cyprus?", metadata: {} },
		// Weather
		{ text: "κάνει κρύο", english: "it's cold", metadata: { grammar: "impersonal" } },
		{ text: "κάνει ζέστη", english: "it's hot/warm", metadata: { grammar: "impersonal" } },
		{ text: "είμαι κρυωμένος", english: "I have a cold", metadata: { grammar: "masculine" } },
		// Time expressions
		{ text: "σε μια εβδομάδα", english: "in one week", metadata: { pattern: "σε + accusative" } },
