...
export const LESSON_2026_05_08 = createLesson({
	...
	nouns: [
		...
		{ lemma: "δασκάλα", gender: "feminine", english: "teacher (f)", cefrLevel: "A1" },
		{
			lemma: "νοσοκόμος",
			gender: "masculine",
			english: "nurse (m)",
		...
		{ lemma: "νοσοκόμα", gender: "feminine", english: "nurse (f)", cefrLevel: "A2" },
		{
			lemma: "φοιτητής",
			gender: "masculine",
			english: "student (m)",
		...
		{ lemma: "φοιτήτρια", gender: "feminine", english: "student (f)", cefrLevel: "A1" },
		{
			lemma: "υπεύθυνος",
			gender: "masculine",
		...
		{ lemma: "όνειρο", gender: "neuter", english: "dream", metadata: { note: "pl: τα όνειρα" }, cefrLevel: "A2" },
