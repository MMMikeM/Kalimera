...
export const LESSON_2023_12_09 = {
	...
	phrases: [
		...
		// Likes with να
		{
			text: "τι σου αρέσει να κάνεις;",
			english: "what do you like to do?",
			metadata: { pattern: "αρέσει να + verb" },
		},
		{
			text: "μου αρέσει να τρώω",
			english: "I like to eat",
			metadata: { pattern: "αρέσει να + verb" },
		},
		{
			text: "μου αρέσει να μαγειρεύω",
