...
export const LESSON_2024_12_02 = createLesson({
	...
	nouns: [
		...
		{ lemma: "παππούς", gender: "masculine", english: "grandfather", cefrLevel: "A1" },
		...
		{ lemma: "χωριό", gender: "neuter", english: "village", cefrLevel: "A2" },
		{ lemma: "λίμνη", gender: "feminine", english: "lake", cefrLevel: "A2" },
		{ lemma: "πόλη", gender: "feminine", english: "city", cefrLevel: "A1" },
		{ lemma: "ιατρική", gender: "feminine", english: "medicine (field)", cefrLevel: "B2" },
		{ lemma: "πανεπιστήμιο", gender: "neuter", english: "university", cefrLevel: "A2" },
		{ lemma: "φοιτητής", gender: "masculine", english: "student (male)", cefrLevel: "A1" },
		{ lemma: "φοιτήτρια", gender: "feminine", english: "student (female)", cefrLevel: "A1" },
		{ lemma: "μαθηματικός", gender: "masculine", english: "mathematician", cefrLevel: "B1" },
		{ lemma: "ρολόι", gender: "neuter", english: "watch/clock", cefrLevel: "A1" },
		{ lemma: "φορά", gender: "feminine", english: "time (instance)", cefrLevel: "A2" },
	],
