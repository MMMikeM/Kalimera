...
export interface VocabularyTable {
  ...
  word_type: 'noun' | 'verb' | 'adjective' | 'adverb' | 'phrase' | 'preposition' | null
...
export interface VerbConjugationsTable {
  id: Generated<number>
...
export type VerbConjugation = Selectable<VerbConjugationsTable>
export type NewVerbConjugation = Insertable<VerbConjugationsTable>
export type VerbConjugationUpdate = Updateable<VerbConjugationsTable>

// Practice Sessions Table
export interface PracticeSessionsTable {
  id: Generated<number>
  session_type: 'vocab_quiz' | 'case_drill' | 'conjugation_drill' | 'weak_area_focus' | null
  category: string | null
